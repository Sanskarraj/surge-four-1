    ...
    <div class="tw-container tw-mx-auto tw-text-center md:tw-text-left">
      <div class="tw-text-center">
        ...
        <h3 class="tw-text-xl tw-font-semibold tw-text-indigo-800 dark:tw-text-indigo-100 md:tw-text-5xl 2xl:tw-text-6xl">
          Our Legacy <br>In Modern Business Landscape
        </h3>
      </div>
      <div class="tw-mx-auto tw-gap-8 dark:tw-text-orange-50 lg:tw-grid lg:tw-grid-cols-12 2xl:tw-w-4/5">
        ...
        >
          ...
          <p style="font-size: 19px;" ><strong>Dynamic Innovators</strong></p>
            
        </div>
        <div class="tw-col-span-9 lg:tw-mt-10">
When it comes to delivering bleeding edge digital solutions,we trust our team to get the job done.
          <p></p>
        </div>
        ...
        >
          ...
          <p style="font-size: 18px;" ><strong>Dependably Creative</strong></p>
        
        </div>
        <div class="tw-col-span-9 lg:tw-mt-6">
Our clients choose us for our innovation, and stay for our ability to successfully deliver on time and budget.
          <p></p>
        </div>
        ...
        >
          ...
          <span class="tw-i-ph-asterisk-bold tw-h-10 tw-w-10 tw-text-indigo-700 dark:tw-text-amber-200" /> -->
          <p style="font-size: 18px;" ><strong>Practicing Our Craft</strong></p>
        
        </div>
        <div class="tw-col-span-9 lg:tw-mt-6">
          <p>

          We’ve always been huge believers in exploring and experimenting with new technologies, ideas and trends.</p>
        </div>
      </div>
    </div>
  </div>
